...
export default function Week_plan() {
    return (
        <>
                            ...
                            <div class="row">
                                        ...
                                        <div class="vc_general vc_cta3 vc_cta3-style-custom vc_cta3-shape-rounded vc_cta3-align-left vc_cta3-icon-size-md vc_cta3-actions-bottom" style={{backgroundColor:'#8444bc'}}>
                                            <div class="vc_cta3_content-container" id="showContain1">
                                                <div class="vc_cta3-content"><header class="vc_cta3-content-header">
                                                    <h2 style={{color:'#ffffff'}}>1 Day</h2><h4 style={{color:'#ffffff'}}>INR 700</h4>
                                                    </header>
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="vc_general vc_cta3 vc_cta3-style-custom vc_cta3-shape-rounded vc_cta3-align-left vc_cta3-icon-size-md vc_cta3-actions-bottom" style={{backgroundColor:'#8444bc'}}>
                                                <div class="vc_cta3_content-container" id="showContain1">
                                                    <div class="vc_cta3-content"><header class="vc_cta3-content-header">
                                                        <h2 style={{color:'#ffffff'}}>7 Day</h2><h4 style={{color:'#ffffff'}}>INR 1300</h4>
                                                        </header>
                                                    </div>
                                                        <div class="vc_cta3-actions">
                                                        <div class="vc_btn3-container vc_btn3-center responsive_js_composer_custom_css_495954661">
                           ...
                           <div class="row">
                            <div class="col-md-6">
                                <div class="vc_general vc_cta3 vc_cta3-style-custom vc_cta3-shape-rounded vc_cta3-align-left vc_cta3-icon-size-md vc_cta3-actions-bottom" style={{backgroundColor:'#8444bc'}}>
                                                    <div class="vc_cta3_content-container" id="showContain1">
                                                        <div class="vc_cta3-content"><header class="vc_cta3-content-header">
                                                            <h2 style={{color:'#ffffff'}}>3 Day</h2><h4 style={{color:'#ffffff'}}>INR 1000</h4>
                                                            </header>
                                                        </div>
                                                            <div class="vc_cta3-actions">
                                                            <div class="vc_btn3-container vc_btn3-center responsive_js_composer_custom_css_495954661">
                            ...
                            <div class="vc_general vc_cta3 vc_cta3-style-custom vc_cta3-shape-rounded vc_cta3-align-left vc_cta3-icon-size-md vc_cta3-actions-bottom" style={{backgroundColor:'#8444bc'}}>
                                                    <div class="vc_cta3_content-container" id="showContain1">
                                                        <div class="vc_cta3-content"><header class="vc_cta3-content-header">
                                                            <h2 style={{color:'#ffffff'}}>15 Day</h2><h4 style={{color:'#ffffff'}}>INR 1650</h4>
                                                            </header>
                                                        </div>
                                                            <div class="vc_cta3-actions">
                                                            <div class="vc_btn3-container vc_btn3-center responsive_js_composer_custom_css_495954661">
